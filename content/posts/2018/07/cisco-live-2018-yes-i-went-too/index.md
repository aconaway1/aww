---
title: "Cisco Live 2018 - Yes, I Went Too"
date: 2018-07-04
categories: 
  - "cisco"
tags: 
...
It's been a very busy month or so. June is always like that, it seems. There's [ARRL Field Day](http://www.arrl.org/field-day), which is always the last rainy weekend in June. This year, Cisco Live was in June, and that typically includes [Tech Field Day activities](http://techfieldday.com/event/clus18/). Right before that, we had the whole family in town for a family reunion. There was all sorts of stuff going on. Now that most of that has blown over, I've collected my thoughts and wanted to talk about Cisco Live this year.

Those who are of any importance in the networking world (LOL!) converged on Orlando this to attend the conference. Orlando brings back all sorts of memories -- from [Taverna Opa](https://opaorlando.com/) to [Sizzler](https://twitter.com/EdHenry_) to [LISP explained with plates](https://twitter.com/aconaway/status/1004191143343591424) -- and we're all familiar with the Orange County Convention Center. It's a great facility with enough room to handle the largest of gatherings. I don't think I saw the attendance numbers, but I would guess there were 30,000 attendees at Cisco Live this year. A typical crowd for the event, and the venue was more than adequate.
